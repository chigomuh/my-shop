      ...
      <div className="w-screen flex justify-center my-20">
        <div className="max-w-xl">
          ...
          <p>
            ...
            <strong>
              <i>Storefront › Web Pages.</i>
            </strong>{" "}
            Click Edit next to the Shipping & Returns page and you can change
            this text. A sample returns policy is shown below which you can edit
            as needed.
          </p>
          <br />
          <strong>
