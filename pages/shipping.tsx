    ...
    <>
      ...
      <div className="w-screen flex justify-center my-20">
        <div className="max-w-xl">
          ...
          <br />
          <p>
            To edit this page, log in to your control panel and go to Storefront
            › Web Pages. Click Edit next to the Shipping & Returns page and you
            can change this text. A sample returns policy is shown below which
          ...
          <p>
            ...
            for a full refund. We&apos;ll also pay the return shipping costs if
          ...
          <p>
            ...
            will respond quickly with instructions for how to return items from
            your order.
          </p>
          <br />
